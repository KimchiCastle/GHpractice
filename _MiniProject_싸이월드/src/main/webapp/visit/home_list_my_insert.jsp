			...
			<input type="hidden" name="m_id" value="${ member.m_id }">
					...
					<table class="table">
						...
						<tr>
							...
							<td><input type="password" name="pwd" style="margin-left: 10px;"></td>
						</tr>
						
						<tr style="text-align: left; font-size:15px;">
							<td>내용</td>
							<td><textarea name="content" rows="5" cols="50" style="margin-left: 10px; resize: none;"></textarea></td>
						</tr>
							<tr>
								<td colspan="2" align="center">
									<div style="margin-top: 20px;">	
										<input type="button" value="글올리기" onclick="send(this.form);">
										<input type="button" value="목록보기" onclick="cancel();">
									</div>
								</td>
							</tr>
					</table>
