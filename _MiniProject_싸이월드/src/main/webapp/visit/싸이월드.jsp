            ...
            <div class="wrapper_left">
                <div class="wrapper__left">
                    <div class="wrapper__left__header">
                        <div class="today">
                            <a href="../member/login.jsp"   style="text-decoration: none;">로그인</a>
							<a href="../member/sign_up.jsp" style="text-decoration: none;">회원가입</a>
                        </div>
                    </div>
                        ...
                        <div class="profileWrapper">
                                <div class="today">
                                    <i class="fas fa-user"></i> 
                                       TODAY <span class="zero"></span> | TOTAL <span class="count"></span> 
                                </div>
                                
                                <div class="profile">
                                    <i class="fas fa-phone-alt"></i> ID: 
                                </div>
